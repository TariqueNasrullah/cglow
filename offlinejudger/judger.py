...
where_to_output = "offlineProblemData/generatedOutput/{}.txt".format(submissionid)
...
if language == "C++" or language == "C":
	...
	judge_result_file = open("offlineProblemData/judge_result/{}.txt".format(submissionid), "w")
